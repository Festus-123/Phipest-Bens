...
export const projects: PROJECTS[] = [
    {
        ...
        longDescription: "This project involved a comprehensive renovation of a modern office space, focusing on enhancing productivity and collaboration through strategic layout optimization, new furniture selection, and improved lighting solutions.",
        details: [
    ...
    }, 
    {
        ...
        longDescription: "This project involved the construction of a modern residential hostel designed for comfort and convenience, featuring well-appointed rooms and shared facilities.",
        details: [
    ...
    }, 
    {
        ...
        longDescription: "This project involved the development of a residential estate, featuring a mix of single-family homes and townhouses, with landscaped common areas and amenities.",
        details: [
    ...
    },
    {
        ...
        longDescription: "This project involved the construction of a modern campus hostel designed to provide comfortable and convenient accommodation for students, with shared facilities and communal spaces.",
        details: [
    ...
    },
    {
        ...
        longDescription: "This project involved the construction of a residential building, featuring a mix of apartments and condominiums, with modern amenities and sustainable design features.",
            details: [
    ...
    }, 
    {
        ...
        longDescription: "This project involved the construction of a modern family house, featuring an open floor plan, energy-efficient design, and high-quality materials for a comfortable and stylish living space.",
        details: [
    ...
    }, 
    {
        ...
        longDescription: "This project involved the construction of a modern duplex, featuring two separate living units with shared amenities and a contemporary design aesthetic.",
        details: [
    ...
    },
    {
        ...
        longDescription: "This project involved the construction of an executive duplex mansion, featuring luxurious design elements, high-end finishes, and spacious living areas for a sophisticated lifestyle.",
            details: [
    ...
    },
    {
        ...
        longDescription: "This project involved the construction of a family house, featuring a traditional design with modern amenities, including a spacious backyard and a cozy interior for comfortable family living.",
            details: [
    ...
    },
    {
        ...
        longDescription: "This project involved the construction of a 4-bedroom family flat, featuring a functional layout, modern design elements, and high-quality materials for a comfortable and stylish living space.",
            details: [
    ...
    },
    {
        ...
        longDescription: "This project involved the construction of a family deluxe house, featuring a spacious and luxurious design with high-end finishes, modern amenities, and a beautiful outdoor living area for a comfortable and stylish lifestyle.",
            details: [
    ...
    },
    {
        ...
        longDescription: "This project involved the construction of a modern government hospital, featuring state-of-the-art medical facilities, energy-efficient design, and a patient-centered layout for optimal healthcare delivery.",
            details: [
    ...
    },
    {
        ...
        longDescription: "This project involved the procurement of various supplies and services for public sector organizations.",
        details: [
