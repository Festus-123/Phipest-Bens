...
export const metadata: Metadata = {
  title:
    "Phipest-bens International Nig Ltd - Projects: https://phipest-bens.vercel.app/projects",
  description:
    "Explore completed and ongoing projects by Phipest-bens International Nig Ltd, including construction contracts, import/export operations, retail expansions, and government partnerships.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Showcasing the diverse portfolio of Phipest-bens International Nig Ltd across construction, trade, and government contracts.",
  ...
  twitter: {
    ...
    title: "Phipest-bens International Nig Ltd - Projects",
    description:
      "Explore completed and ongoing projects by Phipest-bens International Nig Ltd across multiple sectors.",
    images: [
      {
        url: "https://phipest-bens.vercel.app/og_projects.png",
        width: 1200,
          ...
          >
            ...
            <div key={index} className="relative p-4 flex flex-col gap-2 h-75">
              ...
              <Link
                ...
                className="absolute right-0 bottom-1 bg-linear-to-r from-blue-400 to-blue-500 text-white/90 rounded-xl p-2 w-50 text-center  hover:from-blue-700 mt-10"
              >
                View project
              </Link>
            </div>
